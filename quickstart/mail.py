...
# MAIL_DIR defined in 'conf.py' ('mails/' by default). If you want to use the
# gmail or no_auth functions, you have to set a confidential.txt file.
...
from pytools.mail import gmail
...
gmail('test', '[Test] Python mail', var_dict=var_dict)
