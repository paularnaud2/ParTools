...
SQ = [
    ...
    "n (TEST_RESTART = True)",
    "Query list modified according previous work in progress. Restarting from query '*'",
...
RL = [
    ...
    "Query list built: 2 894 elements to be processed distributed in 29 groups (100 max per group). They will be processed in parallel by 3 connection pools.",
    "All threads are done",
