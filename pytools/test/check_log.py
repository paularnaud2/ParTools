...
SQ = [
    ...
    "Error: data base * doesn't seem to be defined. Pease check your conf_oracle.py file.",
    "Error: data base * of environment * doesn't seem to be defined. Pease check your conf_oracle.py file.",
    "Make sure the first elements of the first two lines are of different lengths",
