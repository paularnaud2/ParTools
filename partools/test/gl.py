...
import partools.tools.gl as gt
import partools.tools.gl as tools
...
SQL_CNX_INFO = ['USERNAME', 'PWD', 'XE_TNS']
...
P_VDHT = TEST_MAIL + 'last_sent_VDHT.html'
P_VDPT = TEST_MAIL + 'last_sent_VDPT.html'
P_HT = TEST_MAIL + 'last_sent_HT.html'
P_PT = TEST_MAIL + 'last_sent_PT.html'
VAR = '@@NAME@@'
NVAR = 'dear tester'
...
RECIPIENTS = ['Paul ARNAUD (test) <paularnaud2@gmail.com>']
